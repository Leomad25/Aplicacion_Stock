...
public class JF_LoginAdmin extends javax.swing.JFrame {

    public JF_LoginAdmin() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JF_UsersLogin window = new JF_UsersLogin();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jPasswordField1.getText().equals("admin")){
            JF_PanelAdmin panel = new JF_PanelAdmin();
    ...
    private void jPasswordField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordField1KeyTyped
        final char enter = KeyEvent.VK_ENTER;
        if(evt.equals(enter)){
            if(jPasswordField1.getText().equals("admin")){
            JF_PanelAdmin panel = new JF_PanelAdmin();
            panel.setVisible(true);
